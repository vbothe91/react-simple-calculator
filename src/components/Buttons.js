	...
	render() {
		return (
			<div className="button">
				...
				<button name=")" onClick={e => this.props.buttonClick(e.target.name)}>)</button>
				<button name="CE" onClick={e => this.props.buttonClick(e.target.name)}>CE</button>
				<button name="C" onClick={e => this.props.buttonClick(e.target.name)}>C</button><br />
				...
				<button name="+" onClick={e => this.props.buttonClick(e.target.name)}>+</button><br />
				<button name="4" onClick={e => this.props.buttonClick(e.target.name)}>4</button>
				...
				<button name="*" onClick={e => this.props.buttonClick(e.target.name)}>x</button><br />
				<button name="." onClick={e => this.props.buttonClick(e.target.name)}>.</button>
				<button name="0" onClick={e => this.props.buttonClick(e.target.name)}>0</button>
				<button className="circle" name="=" onClick={e => this.props.buttonClick(e.target.name)}>=</button>
				<button name="/" onClick={e => this.props.buttonClick(e.target.name)}>÷</button><br />
			</div>
		);
	}
